...
export const CitationDrawer = () => {
  ...
  return createPortal(
    <div className="fixed inset-0 z-[110] lg:hidden" onKeyDown={handleKeyDown}>
      <div className="absolute inset-0 animate-fade-in bg-scrim/40" onClick={close} aria-hidden />
      ...
      <div
        ...
        className="absolute right-0 top-0 flex h-full w-full animate-slide-in-right flex-col border-l border-line bg-surface pb-[env(safe-area-inset-bottom)] pt-[env(safe-area-inset-top)] shadow-overlay sm:w-[min(760px,92vw)]"
      >
        <PdfSourcePanel
